...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>后台<span class="crumb-step">&gt;</span><a class="crumb-name" href="<%=request.getContextPath()%>/task/admin/1/show_page.do">课题管理</a><span class="crumb-step">&gt;</span><span>查看课题</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="#" method="post" id="myform" name="myform" >
               <!--  enctype="multipart/form-data" -->
               		<input type="hidden" name="tId" id="tId" value="${task.tId}">
                    <table class="insert-tab" width="100%">
                            <tr>
                                <td align="center"><font size="4" >课题：${task.title}</font></td>
                            </tr>
                            <tr>
                            	
                				<td><img alt="${task.title}" src="<%=request.getContextPath()%>/upload/${task.tUrl}" style="width:800px;height:600px"></td>              
                            </tr>
                           <tr>
                            	<td>职位:
                            ...
                            <tr>
                            	<td>更新时间: ${task.uTime}</td>
                            </tr> 
                            <tr>
                                <td>详情:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${task.details}</td>
