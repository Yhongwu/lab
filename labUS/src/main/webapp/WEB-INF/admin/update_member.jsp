                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="tel" name="tel" size="50" value="${member.tel}" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>传真：</th>
                                <td>
                                    <input class="common-text required" id="fax" name="fax" size="50" value="${member.fax}" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>邮箱：</th>
                                <td>
                                    <input class="common-text required" id="email" name="email" size="50" value="${member.email}" type="text">
                                </td>
                            </tr>
                            <!-- <tr>
                                <th>作者：</th>
