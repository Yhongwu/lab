...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>后台<span class="crumb-step">&gt;</span><a class="crumb-name" href="<%=request.getContextPath()%>/hometopic/admin/1/show_page.do">轮播管理</a><span class="crumb-step">&gt;</span><span>更新</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<%=request.getContextPath() %>/hometopic/admin/update.do" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkform(this)">
              		...
              		<input type="hidden" id="hUrl" name="hUrl" value="${hometopic.hUrl }">
              		<input type="hidden" id="oldImage" name="oldImage" value="${hometopic.hUrl }">
              		<input type="hidden" id="hId" name="hId" value="${hometopic.hId }">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="hTitle" name="hTitle" size="50" value="${hometopic.hTitle }" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr><td></td><td><img id="imghead" style="width:300px;height:250px" src="<%=request.getContextPath()%>/upload/${hometopic.hUrl}"></td></tr> 
                            <tr>
                                <th>超链接地址：</th>
                            ...
                            <tr>
                                <th>摘要：</th>
                                <td><textarea name="hContent" class="common-textarea" id="hContent" cols="30" style="width: 98%;" rows="10">${hometopic.hContent}</textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
