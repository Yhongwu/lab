    	...
    	if(validateImage(obj)){
    		...
    		$.ajaxFileUpload({  
                ...
                {  
                    ...
                    $("#imghead").attr("src", "<%=request.getContextPath()%>/upload/"+a[0]); 
                    $("#pUrl").attr("value", a[0]); 
                    if(a.length==2){
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>后台<span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/<%=request.getContextPath()%>/press/admin/1/show_press.do">文章管理</a><span class="crumb-step">&gt;</span><span>更新文章</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<%=request.getContextPath() %>/press/admin/update.do" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkform(this)">
              		<input type="hidden" id="oldvurl" name="oldvurl" value="${press.pVurl}">
              		<input type="hidden" id="pVurl" name="pVurl" value="${press.pVurl}">
              		<input type="hidden" id="oldImage" name="oldImage" value="${press.pUrl }">
              		<input type="hidden" id="pUrl" name="pUrl" value="${press.pUrl }">
              		<input type="hidden" id="pId" name="pId" value="${press.pId }">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="pStatus" id="pStatus" class="required">
                                    <option value="1" <c:if test="${press.pStatus==1 }">selected="selected"</c:if>>是</option>
                                    <option value="0" <c:if test="${press.pStatus==0 }">selected="selected"</c:if>>否</option>
                                </select>
                            </td>
                        </tr>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="pTitle" name="pTitle" size="50" value="${press.pTitle }" type="text">
                                </td>
                            </tr>
                            <!-- <tr>
                                <th>作者：</th>
                            ...
                            <tr><td></td><td><img id="imghead" style="width:500px;height:300px" src="<%=request.getContextPath()%>/upload/${press.pUrl}"></td></tr> 
                            <tr>
                                <th>摘要：</th>
                                <td><textarea name="pSummary" class="common-textarea" id="pSummary" cols="30" style="width: 98%;" rows="5" >${press.pSummary}</textarea></td>
                            </tr>
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="pContent" class="common-textarea" id="pContent" cols="30" style="width: 98%;" rows="10">${press.pContent}</textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
