...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>后台<span class="crumb-step">&gt;</span><a class="crumb-name" href="<%=request.getContextPath()%>/link/admin/show.do">链接管理</a><span class="crumb-step">&gt;</span><span>更新链接</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<%=request.getContextPath() %>/link/admin/update.do" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkform(this)">
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="status" id="status" class="required">
                                    <option value="0" <c:if test="${link.status==0}">selected="selected"</c:if>>合作小组</option>
                                    <option value="1" <c:if test="${link.status==1}">selected="selected"</c:if>>相关网站</option>
                                </select>
                            </td>
                        </tr>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="lName" name="lName" size="50" value="${link.lName}" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>链接：</th>
