...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>后台<span class="crumb-step">&gt;</span><a class="crumb-name" href="<%=request.getContextPath()%>/hometopic/admin/1/show_page.do">轮播管理</a><span class="crumb-step">&gt;</span><span>查看详情</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><!-- <tr> -->
                            ...
                            <tr>
                				...
                				<c:if test="${empty hometopic.hVurl}">
                				<img alt="${hometopic.hTitle}" src="<%=request.getContextPath()%>/upload/${hometopic.hUrl}" style="width:500px;height:300px">
                				</c:if>
                				</td>              
                            </tr>
                            <tr>
                            ...
                            <tr>
                            	<td>更新时间: ${hometopic.hTime}</td>
                            </tr> 
                            <tr>
                                <td>摘要：<br>
                                ${hometopic.hSummary}</td>
                            </tr>
                            <tr>
                                <td>内容：<br>
                                ${hometopic.hContent}</td>
                            </tr>
                            <!-- <tr>
                                <td>
