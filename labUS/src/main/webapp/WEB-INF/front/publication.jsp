		...
		<div class="container">
			<div class="member border-box">
				<div class="member-box">
					...
					<ul>
					<c:forEach items="${list}" var="year">
						<li><a href="<%=request.getContextPath() %>/publication/${year}/getpub.do">${year}</a></li>
					</c:forEach>
					</ul>
				</div>
			...
			<%-- <div class="details border-box">
				<div>
					<div>
						<p>Contact us for reprints on any of the following publications ( <a href="#">zcpeng@szu.edu.cn</a>).</p>
			...
			<div class="details border-box">
				...
				<div class="time" id="${time}">
					<p><span>${time}Publications:</span></p>
					<br />
					<ol>
