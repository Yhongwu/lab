...
//		List<Joins> joins = joinsService.search(word);
//		System.out.println("joins"+joins.size());
//		List<Member> members = memberService.search(word);
//		System.out.println("members"+members.size());
//		List<Photo> photos = photoService.search(word);
...
//		List<Publication> publications = publicationService.search(word);
//		System.out.println("publication"+publications.size());
//		List<Task> tasks = taskService.search(word);
