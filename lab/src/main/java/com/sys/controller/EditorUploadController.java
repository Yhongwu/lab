...
public class EditorUploadController {
	...
	public void upload(HttpServletRequest request,   
         ...
         //文件保存本地目录路径  
         String savePath = request.getSession().getServletContext().getRealPath(PATH_LINE) + "upload"+PATH_LINE;  
         //文件保存目录URL  
         String saveUrl = request.getContextPath() + PATH_LINE +"upload"+PATH_LINE; 
    ...
    public void fileManager(HttpServletRequest request, HttpServletResponse response) {  
        try {  
            //根目录路径，可以指定绝对路径  
            String rootPath = request.getSession().getServletContext().getRealPath(PATH_LINE) + "upload"+PATH_LINE;  
            //根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/  
            String rootUrl  = request.getContextPath() + PATH_LINE+"upload"+PATH_LINE;  
