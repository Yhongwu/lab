                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><!-- <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" class="common-text required" id="pYear" name="pYear" size="50" value="${publication.pYear }" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>内容：</th>
