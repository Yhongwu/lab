    	...
    	if(validateImage(obj)){
	        ...
	        $.ajaxFileUpload({  
	            ...
	            {  
		             ...
		             $("#imghead").attr('style','width:100px;height:120px;display:block');
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>后台<span class="crumb-step">&gt;</span><a class="crumb-name" href="<%=request.getContextPath()%>/member/admin/1/show_page.do">成员管理</a><span class="crumb-step">&gt;</span><span>新增成员</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<%=request.getContextPath() %>/member/admin/insert.do" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkform(this)">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="fax" name="fax" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
